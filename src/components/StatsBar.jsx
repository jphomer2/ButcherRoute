function StatCard({ label, value, sub, accent, dim }) {
  ...
  return (
    <div style={{
      background: 'var(--dark)', borderRadius: '8px', padding: '0.9rem 1rem',
...
export default function StatsBar({ stops, totalMiles, estMinutes }) {
  ...
  return (
    <div style={{ display: 'flex', gap: '0.75rem', padding: '1rem 1.5rem', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
